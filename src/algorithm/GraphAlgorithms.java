...
public class GraphAlgorithms {
     ...
     * 5. 重复直到队列为空
     */
    public int[] BFS(SocialGraph graph, int startId) {
        ...
        while (queueHead < queueTail) {
            ...
            //遍历当前节点的所有邻居
            for (int i = 0; i < graph.adjListCount[currentNode]; i++) {
     ...
     */
    public int[] Dijkstra(SocialGraph graph, int fromId, int toId) {
        int totalNodes = graph.nodeCount;
        ...
        for (int k = 0; k < totalNodes; k++) {
            ...
            for (int i = 0; i < graph.adjListCount[closestNode]; i++) {
